    ...
    try:
        ...
        spark_application_config = {
            ...
            "spec": {
                "type": "Scala",
                "mode": "cluster",
                "image": "nickpeachey/another-spark-job:0.0.2", # IMPORTANT: Replace with your actual Spark image (e.g., with Hadoop S3A support)
                "imagePullPolicy": "Always",
                "mainClass": "com.cawooka.MainExecutor", # IMPORTANT: Replace with your Scala main class
                "mainApplicationFile": "local:///opt/spark/jars/another-spark-job.jar", # IMPORTANT: Path to your JAR inside the Spark image
                "sparkConf": {
...
# Your DAG definition
with DAG(
    dag_id="another_spark_job_with_localstack",
    ...
    submit_spark_job = SparkKubernetesOperator(
        task_id="another_spark_job_with_localstack_submit_scala_job",
