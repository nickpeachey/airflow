    ...
    try:
        ...
        spark_application_config = {
            ...
            "spec": {
                "type": "Scala",
                "mode": "cluster",
                "image": "nickpeachey/sparkminiosaver:4.0.2", # IMPORTANT: Replace with your actual Spark image (e.g., with Hadoop S3A support)
                ...
                "sparkConf": {
                    ...
                    "spark.kubernetes.driver.pod.retention.policy": "Never",
                },
                "driver": {
                    "cores": 1,
                    "memory": "1g",
